...
const Accounts = require ('../Accounts/huluaccounts.json');
...
exports.run = async (client, message, args) => {
    ...
    .setDescription(`<@${message.author.id}>` + ` has generated a Hulu account the account info is ${Accounts[result]}`)
